...
class TeraWurflConfig{
	 ...
	 * @var String
	 */
	public static $DB_HOST = "127.4.134.129";
	/**
	 * Database User
	 ...
	 * @var String
	 */
	public static $DB_PASS = '64dgt434liZ1';
	/**
	 * Database Name / Schema Name
	 * @var String
	 */
	public static $DB_SCHEMA = "greport";
	/**
	 ...
	 * @var String
	 */
	public static $WURFL_DL_URL = "http://garr.dl.sourceforge.net/project/wurfl/WURFL/2.3.3/wurfl-2.3.3.zip";
	/**
